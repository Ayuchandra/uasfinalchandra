            ...
            <table class="table-fixed w-full text-center border-b">
                <thead class="bg-blue-900 text-center">
                    <tr>
                        ...
                        <th class="w-auto px-4 py-2 text-white">Tanggal pengembalian</th>
                ...
                <tbody class="text-center">
                    ...
                    <tr class="">
                        ...
                        <td>{{ $pt->created_at }}</td>
                        {{-- <td>
                            <button type="button" class="w-1/4 bg-red-500 hover:bg-red-700 text-white font-bold my-1 py-2 px-2 rounded" wire:click="delete({{ $pt->id }})"
